	...
	<div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{'payslip.yearly'}}"><i class="fa fa-file-text-o"></i>Payslip Yearly</a></li>
            	...
            	<div class="col-xs-12">
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
			                ...
			                <div class="col-md-6">
			                    @foreach($yearly->detailElementType('Allowance') as $mtdd)
			                ...
			                <div class="col-md-6 margin-bottom-30">
			                    @foreach($yearly->detailElementType('Deduction') as $mtdd)
			                        <div class="col-md-8 bg-silver font-size-subheader margin-bottom-5">{{$mtdd->element->name}}</div>
			                        <div class="col-md-4 bg-value font-size-subheader margin-bottom-5">
			                            <span>Rp. </span><span class="text-right numbers pull-right">{{$mtdd->value}}</span>
			                        </div>
			                ...
			                <div class="col-md-12 text-bold font-size-subheader bg-silver margin-bottom-5" style="padding-right: 0px;">
			                    ...
			                    <div class="col-md-4 bg-value">
			                        <span>Rp. </span>
			                        <span class="text-right numbers pull-right" style="margin-right: 15px;">{{$yearly->total_allowance}}</span>
			                    </div>
			                </div>
			                <div class="col-md-12 text-bold font-size-subheader bg-silver margin-bottom-5" style="padding-right: 0px;">
			                    ...
			                    <div class="col-md-4 bg-value">
			                        <span>Rp. </span>
			                        <span class="text-right numbers pull-right" style="margin-right: 15px;">{{$yearly->total_deduction}}</span>
			                    </div>
			                </div>
			                <div class="col-md-12 text-bold font-size-subheader bg-silver margin-bottom-30" style="padding-right: 0px;">
			                    ...
			                    <div class="col-md-4 bg-value">
			                        <span>Rp. </span>
			                        <span class="text-right numbers pull-right" style="margin-right: 15px;">{{$yearly->total_take_home_pay}}</span>
			                    </div>
			                </div>
